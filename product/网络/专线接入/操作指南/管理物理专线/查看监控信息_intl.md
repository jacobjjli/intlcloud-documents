You can query the monitoring data (outbound and inbound bandwidth, packet loss, and latency) of Connections in the console or via API. The console operations are as follows:
